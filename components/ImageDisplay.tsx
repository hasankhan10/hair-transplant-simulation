...
const ImageDisplay: React.FC<ImageDisplayProps> = ({
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      // Simulation Outcome Label
      ctx.fillStyle = '#D71A21'; // Primary color for emphasis
      ctx.fillText('SIMULATION OUTCOME', widthBefore + (widthAfter / 2), targetHeight + 60);

      // --- TAMPER-RESISTANT MICRO WATERMARK (Repeating Diagonal) ---
      ...
      // Use a premium Dark Secondary background (matches Header)
      ...
      // Legal Disclaimer (Below Logo Strip)
      ctx.fillStyle = '#000000';
      ...
      // --- TRACEABILITY METADATA (Bottom Center Tiny) ---
